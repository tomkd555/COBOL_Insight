# Applies the Japanese identifier patches to a clean checkout of vendor/che4z
...
#
# Prerequisites:
#   - vendor/che4z is a clean checkout (no local modifications).
#   - JDK 21 and Maven are available (paths below).

$ErrorActionPreference = "Stop"

$repoRoot = (Resolve-Path (Join-Path $PSScriptRoot "..\..\..")).Path
$che4zDir = Join-Path $repoRoot "vendor\che4z"
...
Write-Host "vendor/che4z patched and built."
