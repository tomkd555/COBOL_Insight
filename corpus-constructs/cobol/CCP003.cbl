      ...
      *----------------------------------------------------------*
       ...
       0000-MAIN.
           ...
           IF WS-INFILE-STATUS NOT = '00'
               DISPLAY 'CCP003 INFILEオープン異常 STATUS='
                       WS-INFILE-STATUS
               MOVE 'N' TO WS-OPEN-OK
           END-IF
           OPEN OUTPUT OUTFILE
           IF WS-OUTFILE-STATUS NOT = '00'
               DISPLAY 'CCP003 OUTFILEオープン異常 STATUS='
                       WS-OUTFILE-STATUS
               MOVE 'N' TO WS-OPEN-OK
           END-IF
           IF WS-OPEN-OK = 'Y'
               ...
               CLOSE INFILE
               IF WS-INFILE-STATUS NOT = '00'
                   DISPLAY 'CCP003 INFILEクローズ異常 STATUS='
                           WS-INFILE-STATUS
               END-IF
               CLOSE OUTFILE
               IF WS-OUTFILE-STATUS NOT = '00'
                   DISPLAY 'CCP003 OUTFILEクローズ異常 STATUS='
                           WS-OUTFILE-STATUS
               END-IF
           ELSE
       ...
       1000-READ-LOOP.
           ...
           IF NOT WS-EOF AND WS-INFILE-STATUS NOT = '00'
               DISPLAY 'CCP003 INFILE読込異常 STATUS='
                       WS-INFILE-STATUS
               MOVE 'Y' TO WS-EOF-FLAG
           END-IF
           IF NOT WS-EOF
               ...
               WRITE OUT-REC
               IF WS-OUTFILE-STATUS NOT = '00'
                   DISPLAY 'CCP003 OUTFILE書込異常 STATUS='
                           WS-OUTFILE-STATUS
               END-IF
           END-IF.
