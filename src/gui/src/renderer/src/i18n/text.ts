...
export const text = {
  ...
  explorer: {
    ...
    typeLabel: "種別で絞り込む",
    tree: "資産ツリー",
    emptyNoFolder: "資産フォルダを選ぶと、ここに資産が並びます。",
    loading: "走査しています…",
  ...
  problems: {
    ...
    emptyNoFolder: "資産フォルダを選ぶと、ここに指摘が並びます。",
    loading: "検出しています…",
    ...
    detailHint: "行を選ぶと、ここに指摘の詳細が出ます。",
    detailRelated: "関係する行",
    detailRule: "ルールの説明を見る",
    showFix: "修正案を見る",
  ...
  output: {
    ...
    emptyNoFolder: "資産フォルダを選ぶと、ここに実行ログが出ます。",
    clear: "ログを消す",
  },
  ...
  transpileView: {
    ...
    java: "Java",
    loading: "変換しています…",
    error: "変換結果を取得できませんでした。出力を確認してください。",
  ...
  save: {
    ...
    savedWithErrors: (path: string, count: number): string =>
      `${path} を保存しました。保存時の検証で ${count} 件の誤りが見つかりました。`,
    failed: (path: string, reason: string): string =>
      `${path} を保存できませんでした。${reason} 出力を確認してください。`,
    nothingToSave: "保存する編集がありません。",
    dirtyBeforeFolderChange:
      "編集中の資産があります。保存するか編集を破棄してから、資産フォルダを切り替えてください。",
    conflictTitle: "原本が書き換わっています",
    conflictBody: (path: string): string =>
      `${path} は、開いたあとにこのツールの外で書き換わりました。上書きすると、その変更は失われます。再読み込みすると、編集中の内容は失われます。`,
    overwrite: "上書きする",
    reload: "再読み込みする",
    showDiff: "差分を見る",
    conflictCancel: "やめる",
  ...
  fixView: {
    title: "修正案",
    loading: "修正案を作っています…",
    error: "修正案を取得できませんでした。出力を確認してください。",
    empty: "この資産に対する修正案はありませんでした。",
    original: "原本",
    fixed: "修正案",
    apply: "修正案を書き出す",
    applied: (dir: string): string => `${dir} へ修正案を書き出しました。`,
  },

  graph: {
    title: "呼出関係図",
    empty: "解析すると、ここに呼出関係図が出ます。",
    emptyNoFolder: "資産フォルダを選ぶと、ここに呼出関係図が出ます。",
    loading: "呼出関係を読み込んでいます…",
    laying: "配置を計算しています…",
    error: "呼出関係を読めませんでした。もう一度解析してください。",
    noNodes: "呼出関係のノードがありません。JCLかCOBOLを含むフォルダを解析してください。",
    canvas: "呼出関係図。ノードを押すと右に情報が出ます。キーボードでは左の実行順から選びます。",
    search: "ノードを名前で絞り込む",
    searchLabel: "ノードを名前で絞り込む",
    depth: "深さ",
    depthLabel: "中心から辿る深さ",
    clearFocus: "起点を解除",
    zoomIn: "拡大",
  ...
  customRules: {
    ...
    validationFailed: "解析エンジンがこの内容を受け付けませんでした。",
    dirty: "未保存の変更があります。",
    fieldId: "ID",
    fieldName: "名前",
    fieldCategory: "分類",
    ...
    problem: {
      ...
      messageRequired: "指摘の文言を入力してください。",
      regexRequired: "正規表現を入力してください。",
      verbRequired: "対象の動詞を入力してください。",
      afterVerbRequired: "起点の動詞を入力してください。",
      dataItemRequired: "検査するデータ項目を入力してください。",
    },
  },
  ...
  import: {
    ...
    paste: "端末から複写した本文",
    kind: "資産の種別",
    copybookNote: "コピー句には拡張子.cpyを補います。",
    destDir: "保存先",
    ...
    columnFrom: "開始桁",
    columnTo: "終了桁",
    columnsNote: "端末の表示桁で数えます（1起点・両端を含む）。",
